                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <button id="{{$data->id}}" type="button" class="information btn btn-sm btn-light mb-2 me-4 _effect--ripple waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                show
                            </button>
                        </td>
                        <td class="text-center">
                            <a href="{{url('/vehicle/'.$data->id.'/edit')}}" class="bs-tooltip" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-original-title="Update" data-bs-original-title="Update" aria-label="Update"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit">
...
<div class="modal fade modal-notification" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
