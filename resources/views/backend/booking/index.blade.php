                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button id="{{$data->id}}" type="button"
                                class="approval btn btn-sm btn-light mb-2 me-4 _effect--ripple waves-effect waves-light"
                        ...
                        <td class="text-center">
                            ...
                            <button id="{{$data->id}}" type="button"
                                ...
                                data-bs-toggle="modal" data-bs-target="#modalInformation">
                                show
                            </button>
                        </td>
                        <td>
                            <a href="{{url('/booking/'.$data->id.'/edit')}}" class="bs-tooltip" data-bs-toggle="tooltip"
                            ...
                            <form action="{{url('booking/'.$data->id)}}" method="post" style="display: inline-block;">
                                @csrf
                                @method('delete')
...
<div class="modal fade modal-notification" id="modalInformation" tabindex="-1" role="dialog"
...
<div class="modal fade modal-notification" id="modalApproval" tabindex="-1" role="dialog"
