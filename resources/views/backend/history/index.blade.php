...
@section('sub_page', 'History Lists')

@section('content')
<div class="row layout-top-spacing">
    <a href="{{url('/history/report')}}" style="color: lightgreen; float: right; margin-bottom:30px;" class="btn btn-primary _effect--ripple waves-effect waves-light">
            ...
            <table id="zero-config" class="table table-striped dt-table-hover" style="width: 100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{$data->start}} to {{$data->finish}}</td>
